...
<div class="p-4">
    ...
    <p>
        You can create a new projects item by creating a new file in the <code>_projects</code> folder. It gives you the highest flexibility to customize the item using any HTML code.
    </p>
    <p>
